...
static int compute_loss_and_upper_bound(WeightSum lb){
   ...
   * A no-replacement/no-loss ordering is not enough evidence that the lower
   * bound cannot be improved by later Beta/AQ rounds; stopping here caused
   * exp-8 dense/structured instances to leave LB unchanged after 1-2 rounds.
   */
